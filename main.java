/*
 * Morpheus — OTC trading client for the Otc (EVM) contract.
 * Supports listing orders, posting, filling, and cancelling. Crypto and RWA asset types.
 * Single-file app; run with: java Morpheus.java (or compile then java Morpheus).
 */
...
public final class Morpheus {
    ...
    private static final String CONFIG_FILENAME = "morpheus.conf";
